...
**ppca** is a Python library for Probabilistic PCA that actually handles missing data gracefully, without requiring you to impute first and pray later. It uses the EM algorithm under the hood, with the heavy lifting done in Rust so you're not waiting around.
